...
public:
  ...
  std::string GetTypeDisplayName() override {return "Label";};

  /// Get markup short name
  std::string GetDefaultNodeNamePrefix() override {return "LL";}
  ...
  vtkGetMacro(LabelLocation, int);
  void SetLabelLocation(int pointId);
